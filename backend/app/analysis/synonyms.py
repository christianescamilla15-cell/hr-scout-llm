"""Skill synonym groups + display names.

Ported verbatim from `src/constants/synonyms.js` so the backend scorer
produces results identical to the frontend reference engine. Any change
here MUST be mirrored in the JS file to keep the demo and the SaaS
...
SYNONYMS: dict[str, list[str]] = {
    ...
    "base de datos": [
        "base de datos", "sql", "postgresql", "mysql", "mongodb", "database",
    ],
...
STOPWORDS: frozenset[str] = frozenset({
    "de", "en", "con", "para", "del", "las", "los", "una", "uno", "que",
    "por", "mas", "sin", "como", "ser", "anos", "ano", "experiencia",
    "buscamos", "profesional", "capacidad", "conocimiento", "minimo",
    "avanzado", "basico", "intermedio", "senior", "junior", "trabajar",
})
